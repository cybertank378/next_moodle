# Issue 15 — Question Bank Vertical Slice
...
Question categories + question CRUD/import/move/duplicate berdasarkan `local_examapi` contract yang benar-benar terdaftar.
...
src/app/(protected)/dashboard/questions/
src/app/(protected)/dashboard/questions/create/
src/app/(protected)/dashboard/questions/[id]/
src/app/(protected)/dashboard/questions/[id]/edit/
```
...
- [ ] Semua port di satu `domain/interfaces/QuestionsInterfaces.ts`.
- [ ] Implement `GetQuestionsUseCase` beserta tests.
- [ ] Implement `GetQuestionUseCase` beserta tests.
- [ ] Implement `CreateQuestionUseCase` beserta tests.
- [ ] Implement `UpdateQuestionUseCase` beserta tests.
- [ ] Implement `DeleteQuestionUseCase` beserta tests.
- [ ] Implement `ImportQuestionsUseCase` beserta tests.
...
- Contract mapping: OCC expected_timemodified, dryrun import, row diagnostics, production-readiness gate
